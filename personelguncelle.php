...
<body>
    <form method="POST" action="update_personel_info.php">
        <label class="label2">Personel Bilgilerini Güncelle:</label>
        ...
        <label for="maas">Ücret:</label>
        <input type="text" name="maas" required pattern="[0-9]*">
        ...
        function fillForm() {
            ...
            xmlhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    document.getElementsByName('maas')[0].value = data.maas;

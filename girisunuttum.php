...
if(isset($_POST["unuttum"])) {
    ...
    if($c == 0) {
        ...
        else
        {
            ...
            $code = uniqid();
            if($db->query("UPDATE admin_kayit SET code='".$code."' WHERE tc='".$Atc."' AND email='".$Amail."'")) {
                ...
                $icerik = "".$Atc." Tc Kimlik numaralı Yönetici:<br> Şifrenizi değiştirmek için kodunuz: <b>".$code."</b><br> Aşağıdaki linke tıklayarak gidin:<br> <a href='http://hazaryilmaz.com/yoneticisifredegistir.php'>Buraya tıklayın</a>";
                $mail->msgHTML($icerik);

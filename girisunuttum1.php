    ...
    if($c == 0) {
        ...
        else
        {
            ...
            if($db->query("UPDATE musteri_kayit SET code='".$code."' WHERE tc='".$Atc."' AND email='".$Amail."'")) {
                ...
                $icerik = "".$Atc." Tc Kimlik numaralı Kullanıcı:<br> Şifrenizi değiştirmek için kodunuz: <b>".$code."</b><br> Aşağıdaki linke tıklayarak gidin:<br> <a href='http://hazaryilmaz.com/musterisifredegistir.php'>Buraya tıklayın</a>";
                $mail->msgHTML($icerik);

    ...
    if($Amail != "" && $Asifre1 != "" && $Asifre2 != "" && $Atc != "" && $Acode != "") {
        if($Asifre1 == $Asifre2) {
            ...
            if($c != 0) {
                ...
                if($db->query("UPDATE admin_kayit SET sifre='".$hashedPassword."', code='' WHERE email='".$Amail."'")) {
                    echo "<script>
                    ...
                    echo "<script>
                        if (confirm('Bir sorun oluştu.')) {
                            window.location.href = 'yoneticisifredegistir.php.php';
                        } else {
                            window.location.href = 'yoneticisifredegistir.php.php';
                        }
                    </script>";
                ...
                echo "<script>
                    if (confirm('Girdiğiniz bilgiler veya kodunuz hatalı.')) {
                        window.location.href = 'yoneticisifredegistir.php';
                    } else {
                        window.location.href = 'yoneticisifredegistir.php';
                    }
                </script>";

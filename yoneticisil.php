...
<head>
    <meta charset="UTF-8">
    <title>Yönetici Bilgilerini Sil</title>
    <style>
        body {
            display: flex;
...
<body>
    <form method="POST" action="sil_admin_info.php">
        <label class="label2">Yönetici Bilgilerini Sil:</label>
        ...
        <br>
        <input type="submit" value="Yöneticiyi Sil">
    </form>
    <script>
